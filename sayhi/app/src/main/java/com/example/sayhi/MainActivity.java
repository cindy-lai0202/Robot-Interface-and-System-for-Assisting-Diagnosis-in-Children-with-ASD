...
public class MainActivity extends RobotActivity { ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        robotAPI.robot.setExpression(RobotFace.ACTIVE,"哈囉"+inputname+"你好啊!");
        robotAPI.robot.setExpression(RobotFace.ACTIVE,"我是zenbo機器人");
        robotAPI.robot.setExpression(RobotFace.ACTIVE,"我們一起來玩遊戲吧");
    ...
    private Runnable timerUpdateTask = new Runnable() {
        ...
        public void run() {
            ...
            if (currentTimer >6) {
            ...
            else if(currentTimer < 7 && currentTimer>0) {
                ...
                stopRecordingVideo();
                fileUri = Uri.fromFile(new File("/storage/emulated/0/Android/data/com.example.sayhi/files/"+name));
                uploadVideo();
