...
public class MainActivity extends RobotActivity {
    ...
    private static CameraCaptureSession cameraPrewSession;
    private static CameraDevice cameraDevice;
    private static Size prewSize;
    ...
    private static Boolean isRecordingVideo = false;
    String inputname;
    static String number;
    static int n=0;
    public final static String DOMAIN = "799AF8CD891A4E5F9D820BB887F3BBBB";
    @Override
    ...
    protected void onResume() {
        ...
        // jump dialog domain
        robotAPI.robot.jumpToPlan(DOMAIN, "launch");
        //mTextView.setText("今天爸爸帶我出去玩");
        // listen user utterance
        robotAPI.robot.setExpression(RobotFace.ACTIVE,inputname+"跟著我一起唸");
        //robotAPI.robot.speak("今天爸爸帶我出去玩");
        robotAPI.robot.speakAndListen("我要去玩", new SpeakConfig().timeout(60));
        //mTextView.setText("今天天氣很好，很適合出去玩");
        robotAPI.robot.speakAndListen("今天天氣很好", new SpeakConfig().timeout(60));
        //mTextView.setText("我的肚子餓了，所以媽媽煮飯給我吃");
        robotAPI.robot.speakAndListen("我肚子好餓", new SpeakConfig().timeout(60));
       // mTextView.setText("昨天爸爸騎車載我去買菜");
        robotAPI.robot.speakAndListen("媽媽帶我去上學", new SpeakConfig().timeout(60));
    ...
    public static RobotCallback robotCallback = new RobotCallback() {
        ...
        public void onResult(int cmd, int serial, RobotErrorCode err_code, Bundle result) {
            ...
            Log.e("robotcallback","conResult");
        }

        @Override
        public void onStateChange(int cmd, int serial, RobotErrorCode err_code, RobotCmdState state) {
            super.onStateChange(cmd, serial, err_code, state);
            Log.e("robotcallback","conStatechange");
        ...
        public void initComplete() {
            super.initComplete();
            Log.e("robotcallback","cinitcomplete");
    ...
    public static RobotCallback.Listen robotListenCallback = new RobotCallback.Listen() {
        ...
        public void onFinishRegister() {
            Log.e("robotListenCallback","lonFinishRegister");
        }

        @Override
        public void onVoiceDetect(JSONObject jsonObject) {
            Log.e("robotListenCallback","lonVoiceDetect");
        }

        @Override
        public void onSpeakComplete(String s, String s1) {
            Log.e("robotListenCallback","lonSpeakComplete");
        }

        @Override
        public void onEventUserUtterance(JSONObject jsonObject) {
            Log.e("robotListenCallback","lonEventUserUtterance");
        }
        ...
        public void onResult(JSONObject jsonObject) {
            ...
            n=n+1;
            if (sIntentionID.equals("repeatplan1")) {
                robotAPI.robot.speak("好棒喔~");
                robotAPI.robot.speak("再跟我唸一句");
            }

            else if (sIntentionID.equals("repeatplan2")) {
                robotAPI.robot.speak("好厲害喔~");
                robotAPI.robot.speak("再來一句");
            }

            else if (sIntentionID.equals("repeatplan3")) {
                robotAPI.robot.speak("你真的好棒喔~");
                robotAPI.robot.speak("再跟我唸最後一句");
            }
            else if (sIntentionID.equals("repeatplan4")) {

                robotAPI.robot.speak("好棒喔~");
                robotAPI.robot.speak("你完成了覆誦語句");
            }
            if (n==5){
                stopRecordingVideo();
                fileUri = Uri.fromFile(new File("/storage/emulated/0/Android/data/com.example.repeatapp/files/"+name));
                uploadVideo();
