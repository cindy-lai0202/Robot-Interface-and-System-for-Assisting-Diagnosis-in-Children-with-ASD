    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mradiogroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == mradiobtn.getId()) {
                    myRef.child(id).child("量表").child("沙鈴遊戲").child("知覺動作功能(粗大動作)").setValue("沒有");
                    n = 1;
                    if(n==1&&m==1&&o==1){
                        mbutton.setEnabled(true);
                    }
                } else if (checkedId == mradiobtn2.getId()) {
                    myRef.child(id).child("量表").child("沙鈴遊戲").child("知覺動作功能(粗大動作)").setValue("一般");
                    n = 1;
                    if(n==1&&m==1&&o==1){
                        mbutton.setEnabled(true);
                    }
                } else if (checkedId == mradiobtn3.getId()) {
                    myRef.child(id).child("量表").child("沙鈴遊戲").child("知覺動作功能(粗大動作)").setValue("有");
                    n = 1;
                    if(n==1&&m==1&&o==1){
                        mbutton.setEnabled(true);
                    }
        ...
        mradiogroup2.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == mradiobtn4.getId()) {
                    myRef.child(id).child("量表").child("沙鈴遊戲").child("專注程度").setValue("沒有");
                    m=1;
                    if(n==1&&m==1&&o==1){
                        mbutton.setEnabled(true);
                    }
                } else if (checkedId == mradiobtn5.getId()){
                    myRef.child(id).child("量表").child("沙鈴遊戲").child("專注程度").setValue("一般");
                    m=1;
                    if(n==1&&m==1&&o==1){
                        mbutton.setEnabled(true);
                    }
                }else if(checkedId == mradiobtn6.getId()){
                    myRef.child(id).child("量表").child("沙鈴遊戲").child("專注程度").setValue("有");
                    m=1;
                    if(n==1&&m==1&&o==1){
                        mbutton.setEnabled(true);
                    }
        ...
        mradiogroup3.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == mradiobtn7.getId()) {
                    myRef.child(id).child("量表").child("沙鈴遊戲").child("參與程度").setValue("沒有");
                    o=1;
                    if(n==1&&m==1&&o==1){
                        mbutton.setEnabled(true);
                    }
                } else if (checkedId == mradiobtn8.getId()){
                    myRef.child(id).child("量表").child("沙鈴遊戲").child("參與程度").setValue("一般");
                    o=1;
                    if(n==1&&m==1&&o==1){
                        mbutton.setEnabled(true);
                    }
                } else if(checkedId == mradiobtn9.getId()){
                    myRef.child(id).child("量表").child("沙鈴遊戲").child("參與程度").setValue("有");
                    o=1;
                    if(n==1&&m==1&&o==1){
                        mbutton.setEnabled(true);
                    }
        ...
        mbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(app7.this, choose.class);
