...
public class MainActivity3 extends RobotActivity {
    ...
    int[] card3 = {R.drawable.umbrella,R.drawable.lightbulb,R.drawable.tissuebox};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 5000; i++) {
            ...
            int c = card3[shuffle2];
            card3[shuffle2] = card3[0];
            card3[0] = c;
        }
        robotAPI.robot.setExpression(RobotFace.HIDEFACE, "下雨出門要帶什麼？");
            //question3

        for (int i = 0; i < card3.length; i++) {
            imgs[i].setImageResource(card3[i]);}
            for (int i = 0; i < card3.length; i++) {
                if (card3[i] == R.drawable.umbrella) {
                    imgs[i].setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            robotAPI.robot.setExpression(RobotFace.EXPECTING, "最後一題囉");
                        }
                    });
                } else {
                    imgs[i].setOnClickListener(new View.OnClickListener() {
