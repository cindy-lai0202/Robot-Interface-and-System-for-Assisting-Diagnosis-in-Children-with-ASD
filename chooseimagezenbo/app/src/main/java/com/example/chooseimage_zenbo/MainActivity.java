...
public class MainActivity extends RobotActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        robotAPI.robot.setExpression(RobotFace.HIDEFACE,"你好啊"+inputname+",歡迎來到水果遊戲");
        robotAPI.robot.setExpression(RobotFace.HIDEFACE,inputname+"，可以幫我找出" + str[shuffle] + "嗎?");
                ...
                for (int i = 0; i < card.length; i++) {
                    ...
                    if (shuffle == 0) {
                        if (card[i] == R.drawable.pineapple) {
                            imgs[i].setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    robotAPI.robot.setExpression(RobotFace.ACTIVE,"答對瞜，你好棒!");
                                        ...
                                        uploadVideo();
                                    robotAPI.robot.speak(inputname+",我再來考考你喔!");
                                    robotAPI.robot.speak("這次要找兩種水果");
                                }
                            });
                        } else {
                            imgs[i].setOnClickListener(new View.OnClickListener() {
    ...
    private String getVideoFilePath(Context context) {
        ...
        name="chooseimage1_"+timeStamp+".mp4";
